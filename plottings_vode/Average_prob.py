...
normal_dest_2 = [ 0.0625, 1.0, 0.0002, 0.0005]
uniform_source_2 = [ 1.0, 0.0217, 0.0002, 0.0667]
uniform_dest_2 = [ 0.0032, 0.04, 1.0, 0.0005]
bimodal_source_2 = [ 0.0011, 0.0476, 0.0172, 1.0]
bimodal_dest_2 = [0.1429, 1.0, 0.0769, 0.0004]

# Table 8 (Filtered)
amounts_8 = ['10', '100', '1000', '10000']
normal_source_8 = [0.0500, 1.0000, 0.3333, 0.3333]
normal_dest_8 = [0.3333, 1.0000, 1.0000, 1.0000]
uniform_source_8 = [1.0000, 0.0227, 0.0002, 1.0000]
uniform_dest_8 = [0.0128, 0.0455, 1.0000, 0.5000]
bimodal_source_8 = [0.0011, 0.0500, 0.0179, 1.0000]
bimodal_dest_8 = [0.2500, 1.0000, 0.2000, 1.000]
